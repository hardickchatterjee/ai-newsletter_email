...
Respond with a JSON object with a single key "articles" containing an array. Each item must have:
- "digest_id": the article ID string
- "relevance_score": float between 0.0 and 10.0
